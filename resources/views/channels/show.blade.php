                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('channels.update', $channel->id)}}" method="POST"
                        ...
                        <div class="form-group row justify-content-center"
                            ...
                            @if($channel->editable())
                            <input onchange="document.getElementById('updateChannelForm').submit()" type="file"
                                name="image" id="image" class="d-none">

                            <div class="form-group">
                                <label for="name" class="form-control-label">
                                    Name
                                </label>
                                <input type="text" id="name" name="name" value="{!! $channel->name !!}"
                                    class="form-control">
                            </div>
